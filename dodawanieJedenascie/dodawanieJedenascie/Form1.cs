...
namespace dodawanieJedenascie
{
    public partial class Form1 : Form
    {
        ...
        private void checker1()
        {
            ...
            if(l1.Text == "A") 
            {
                if (suma % 11 == 10 && (suma / 11).ToString() == p1.Text)
                {
                    l2.Enabled = true;
                    p2.Enabled = true;
                }
            ...
            {
                if (suma % 11 == Convert.ToInt32(l1.Text) && (suma / 11).ToString() == p1.Text)
                {
                    l2.Enabled = true;
                    p2.Enabled = true;
                }
        ...
        private void checker2()
        {
            ...
            if (l2.Text == "A")
            {
                if (suma % 11 == 10 && (suma / 11).ToString() == p2.Text)
                {
                    l3.Enabled = true;
                    p3.Enabled = true;
                }
            ...
            {
                if (suma % 11 == Convert.ToInt32(l2.Text) && (suma / 11).ToString() == p2.Text)
                {
                    l3.Enabled = true;
                    p3.Enabled = true;
                }
        ...
        private void checker3()
        {
            ...
            if (l3.Text == "A")
            {
                if (suma % 11 == 10 && (suma / 11).ToString() == p3.Text)
                {
                    l4.Enabled = true;
                    p4.Enabled = true;
                }
            ...
            {
                if (suma % 11 == Convert.ToInt32(l3.Text) && (suma / 11).ToString() == p3.Text)
                {
                    l4.Enabled = true;
                    p4.Enabled = true;
                }
        ...
        private void checker4()
        {
            ...
            if (l4.Text == "A")
            {
                if (suma % 11 == 10 && (suma / 11).ToString() == p4.Text)
                {
                    l5.Enabled = true;
                    p5.Enabled = true;
                }
            ...
            {
                if (suma % 11 == Convert.ToInt32(l4.Text) && (suma / 11).ToString() == p4.Text)
                {
                    l5.Enabled = true;
                    p5.Enabled = true;
                }
        ...
        private void checker5()
        {
            ...
            if (l5.Text == "A")
            {
                if (suma % 11 == 10 && (suma / 11).ToString() == p5.Text)
                {
                    l6.Enabled = true;
                }
            }
            ...
            {
                if (suma % 11 == Convert.ToInt32(l5.Text) && (suma / 11).ToString() == p5.Text)
                {
                    l6.Enabled = true;
                }
            }
